...
exports.AirplayManager = void 0;
const debug_1 = __importDefault(require("debug"));
const config_1 = require("../config");
const logger = (0, debug_1.default)('babelpod:airplay');
...
class AirplayManager {
    ...
    async setupDevice(deviceId, host, port, initialVolume = config_1.config.airplay.defaultVolume) {
        ...
        return new Promise((resolve, reject) => {
            ...
            }, config_1.config.airplay.setupTimeout);
    ...
    getVolume(deviceId) {
        return this.deviceVolumes.get(deviceId) || config_1.config.airplay.defaultVolume;
    }
}
exports.AirplayManager = AirplayManager;
